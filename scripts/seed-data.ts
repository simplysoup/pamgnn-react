...
export const projectSeeds: ProjectSeed[] = [
  ...
  },
  {
    ...
    category: ['identity', 'web-design', 'motion'],
    client: 'Dynastic Wealth® | Concept Creative Group, LLC',
    tools: ['clip-studio', 'illustrator'],
  },
  {
  ...
  },
  {
    ...
    featured: false,
    order: 9,
    summary: 'Fan-reanimated sequence from Avatar: The Last Airbender with full process breakdown.',
